...
class GeometricAttitudeControl
{
 public:
  ...
  void setDragCoeff(const Eigen::Vector3f &drag);
...
private:
  ...
  void computeBodyRateCmd(Eigen::Vector4f &bodyrate_cmd, const Eigen::Vector3f &a_des) ;
  Eigen::Vector4f acc2quaternion(const Eigen::Vector3f &vector_acc, const double &yaw);
